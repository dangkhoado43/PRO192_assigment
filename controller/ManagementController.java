...
public class ManagementController extends EmployeeController {
    ...
    public ManagementController(Management model) {
        this.model = model;
    }
    ...
    public void addEmployee(ArrayList<Employee> employee_list) {
        ...
        Employee employee = new Management();
        ...
        while (flag == false) {
            try {
                ...
                do {
                    ...
                    try {
                        ...
                        if (validate.isInvalidAccount(account)) {
                            System.out.println("Account cannot be blank!!!");
                            isInvalid = true;
                        }
                    } catch (Exception e) {
                        isInvalid = true;
                ...
                do {
                    isInvalid = false;
                    try {
                        System.out.print("Enter date of joining the company (dd/mm/yyyy): ");
                ...
                do {
                    isInvalid = false;
                    try {
                        System.out.print("Enter the number of resolved tasks: ");
                ...
                do {
                    isInvalid = false;
                    try {
                        System.out.print("Enter the number of common tasks: ");
                ...
                flag = true;
                employee = new Management("1", empId, account, workStartingDate, productivityScore, taskDone,
                        taskSpecified);
